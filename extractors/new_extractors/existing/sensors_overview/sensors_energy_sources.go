...
func ExtractSensorsEnergySources(outputFileName string) error {
	...
	var results = struct {
		Results []struct {
			...
			EnergySources structs.EnergySources `json:"energySources"`
		} `json:"results"`
	}{}
	...
	for _, file := range files {
		...
		result.EnergySources = content.ExistingSystem.SensorDetails.EnergySources
