...
const FolderPath = "../result_files/manual_data/extracted_data_from_manual_observatories/existing/event_detection/"
...
func ExtractAutomation(outputFileName string) error {
	...
	for _, file := range files {
		...
		result.Automation = content.ExistingSystem.EventDetectionSystem.Automation
