...
const FolderPath = "../result_files/manual_data/extracted_data_from_manual_observatories/future/health_monitoring/"
...
func ExtractIntegrateAdditionalData(outputFileName string) error {
	...
	for _, file := range files {
		...
		result.IntegrateAdditionalData = content.FutureSystem.SensorHealthMonitoring.IntegrateAdditionalData
