...
const FolderPath = "../result_files/manual_data/extracted_data_from_manual_observatories/future/event_detection/"
const SvelteFolderPath = "../../echarts-report/src/lib/json_files/future/event_detection/"

func ExtractManualDataIntegration(outputFileName string) error {
	...
	for _, file := range files {
		...
		result.ManualDataIntegration = content.FutureSystem.EventDetectionSystem.ManualDataIntegration
