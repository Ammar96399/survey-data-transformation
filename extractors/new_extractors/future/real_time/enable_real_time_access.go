...
const FolderPath = "../result_files/manual_data/extracted_data_from_manual_observatories/future/real_time/"
const SvelteFolderPath = "../../echarts-report/src/lib/json_files/future/real_time/"

func ExtractEnableRealTimeAccess(outputFileName string) error {
	...
	for _, file := range files {
		...
		result.EnableRealTimeAccess = content.FutureSystem.RealTimeSystem.EnableRealTimeAccess
