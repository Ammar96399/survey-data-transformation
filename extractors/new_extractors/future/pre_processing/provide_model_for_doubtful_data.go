...
const FolderPath = "../result_files/manual_data/extracted_data_from_manual_observatories/future/pre_processing/"
const SvelteFolderPath = "../../echarts-report/src/lib/json_files/future/pre_processing/"
...
func ExtractAcceptableNotificationDelay(outputFileName string) error {
	...
	for _, file := range files {
		...
		result.ProvideModelForDoubtfulData = content.FutureSystem.DataClassification.ProvideModelForDoubtfulData
